...
public class BlitzLeaderboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_blitz_leaderboard, container, false);
        ...
        apiService.getLeaderboards().enqueue(new Callback<LeaderboardResponse>() {
            ...
            public void onResponse(Call<LeaderboardResponse> call, Response<LeaderboardResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    playerAdapter = new PlayerAdapter(response.body().getLiveBlitz(), new PlayerAdapter.OnItemClickListener() {
                        @Override
    ...
    private void navigateToAllFragment(String username) {
        ...
        getActivity().getSupportFragmentManager().beginTransaction()
                .replace(R.id.main_fragment_container, informationFragment)
                .addToBackStack(null)
                .commit();
    }
}