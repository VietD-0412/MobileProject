...
public class    RapidLeaderboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_rapid_leaderboard, container, false);
        ...
        apiService.getLeaderboards().enqueue(new Callback<LeaderboardResponse>() {
            ...
            public void onResponse(Call<LeaderboardResponse> call, Response<LeaderboardResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    playerAdapter = new PlayerAdapter(response.body().getLiveRapid(), new PlayerAdapter.OnItemClickListener() {
                        @Override
